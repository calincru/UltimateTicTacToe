...
class table_t {
  ...
  public:
    ...
    // ACCESSORS
    std::pair<bool, player_e> is_finished() const;
    ...
    big_pos_set_t get_smalls_won_by(player_e player) const;
    big_pos_set_t get_smalls_almost_won_by(player_e player) const;
    big_pos_set_t get_smalls_playable() const;
