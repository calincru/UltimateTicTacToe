...
upload_payload() {
    ...
    curl --cookie-jar ~cookie "http://pub.theaigames.com/sign-in" \
    -H "Host: pub.theaigames.com" -H "User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64; rv:36.0) Gecko/20100101 Firefox/36.0" \
    ...
    -H "Referer: http://pub.theaigames.com/" \
    -H "DNT: 1" \
    -H "Connection: keep-alive" \
    -H "Pragma: no-cache" \
    -H "Cache-Control: no-cache" \
    --data "login=Generic&password=40c9e588d093c0bc36b60e0af0de8e0c&zAD2RZSTfdW2tH=bc1bfd0f3eea588d04df2e73cf3608ca" \
    &>/dev/null
    ...
    curl --cookie ~cookie "http://pub.theaigames.com/competitions/ultimate-tic-tac-toe/bots/new" \
    -H "Host: pub.theaigames.com" \
    -H "User-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64; rv:36.0) Gecko/20100101 Firefox/36.0" \
    -H "Accept: */*" \
    -H "Accept-Language: en-US,en;q=0.5" \
    --compressed -H "X-NewRelic-ID: VQIAWVFVGwEAUFBUAQI=" \
    -H "x-requested-with: XMLHttpRequest" \
    -H "Referer: http://pub.theaigames.com/profile" \
