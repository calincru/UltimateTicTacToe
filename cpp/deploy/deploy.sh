...
upload_payload() {
    ...
    --data "login=AproapeBine&password=40c9e588d093c0bc36b60e0af0de8e0c&zAD2RZSTfdW2tH=bc1bfd0f3eea588d04df2e73cf3608ca" \
    &>/dev/null
    ...
    curl --cookie ~cookie "http://theaigames.com/competitions/ultimate-tic-tac-toe/bots/new" \
